...
describe('Configuration loader', function () {
  it('returns an error if file does not exist', function (done) {
    config.load('test/examples/idontexist.json', function (error) {
      should.exist(error);
  ...
  it('returns an error if file is not valid JSON', function (done) {
    config.load('test/examples/invalid.json', function (error) {
      should.exist(error);
  ...
  it('returns an error if file contains no JSON nodes', function (done) {
    config.load('test/examples/empty.json', function (error) {
      should.exist(error);
  ...
  it('returns configuration as parsed object', function (done) {
    config.load('test/examples/maidbot.json', function (error, config) {
